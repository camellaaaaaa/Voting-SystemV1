...
Public Class Admin_Results
    ...
    Private Sub Admin_Results_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Query = "SELECT party_name, full_name, vote, course, year, section FROM candidate WHERE position='President'"
            Query1 = "SELECT party_name, full_name, vote, course, year, section FROM candidate WHERE position='Executive Vice President'"
            Query2 = "SELECT  party_name, full_name, vote, course, year, section FROM candidate WHERE position='Vice President for Academic Affairs'"
            Query3 = "SELECT  party_name, full_name, vote, course, year, section FROM candidate WHERE position='Vice President for Student Services'"
            Query4 = "SELECT  party_name, full_name, vote, course, year, section FROM candidate WHERE position='Vice President for Research and Development'"
            Query5 = "SELECT  party_name, full_name, vote, course, year, section FROM candidate WHERE position='Vice President for Organization Relation'"
            Query6 = "SELECT party_name, full_name, vote, course, year, section FROM candidate WHERE position='Secretary General'"
            Query7 = "SELECT  party_name, full_name, vote, course, year, section FROM candidate WHERE position='Treasurer'"
