...
Public Class Admin_Candidate
    ...
    Private Sub UpdateDG(candidate_id As String)
        Dim sql As String = "UPDATE candidate SET party_name='" + CPartyName.Text + "', position='" + CPosition.Text + "', first_name='" + TFirstName.Text + "', middle='" + TMiddle.Text + "', last_name='" + TLastName.Text + "', course='" + TCourse.Text + "', year='" + TCourse.Text + "', section='" + TSection.Text + "' WHERE candidate_id='" + candidate_id + "'"
