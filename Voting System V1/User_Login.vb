        ...
        Else
            ...
            Try
                ...
                If count = 1 Then
                    ...
                    Dim voter_status = rolereader.GetString("voter_status")
                    If voter_status = "NEW" Then
                        If usertype = "USER" Then
                            connection.Close()
                            connection.Open()

                            Dim command2 As New MySqlCommand("SELECT `first_name`,`student_number` FROM `voters` WHERE `student_number` = @student_number ", connection)
